...
1d = 24h _ 3,600,000ms = 86,400,000ms
\*/
...
- Date 객체의 년도를 나타내는 4자리 숫자를 반환한다.
...
- Date 객체의 년도를 나타내는 4자리 숫자를 설정한다. 년도 이외 월, 일도 설정할 수 있다.
...
- Date 객체의 월을 나타내는 0 ~ 11의 정수를 설정한다. 1월은 0, 12월은 11이다. 월 이외 일도 설정할 수 있다.
...
- Date 객체의 일(0 ~ 6)를 나타내는 정수를 반환한다. 반환값은 아래와 같다.
- 일요일이 0으로 시작하고 토요일이 6으로 끝난다.
...
- Date 객체의 시간(0 ~ 23)를 나타내는 정수를 설정한다. 시간 이외 분, 초, 밀리초도 설정할 수 있다.
...
- Date 객체의 분(0 ~ 59)를 나타내는 정수를 설정한다. 분 이외 초, 밀리초도 설정할 수 있다.
...
- Date 객체의 초(0 ~ 59)를 나타내는 정수를 설정한다. 초 이외 밀리초도 설정할 수 있다.
